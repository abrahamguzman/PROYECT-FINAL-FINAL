...
def eliminar_producto():
    ...
    if opc02 == "0":
        ...
        for i in range(0, numelim):
            listas.camwebcanti.remove(elim)
        print("")
        print(pandixcan2(listas.camwebid, listas.camweb, listas.camwebprecios, [listas.camwebcanti.count("001"),
...
def agregar_producto():
    ...
    if opc02 == "0":
        ...
        for i in range(0, newcanti):
            listas.camwebcanti.append(newid)
        print("\nSu producto fue añadido con éxito.\n")
        print(pandix(listas.camwebid, listas.camweb, listas.camwebprecios))
    elif opc02 == "1":
        print(main.casecantipd)
    elif opc02 == "2":
        opcdisc = input("\n¿Qué tipo de disco?\n"
